...
declare class GMSMarker extends GMSOverlay implements GMUClusterItem {
	...
	snippet: string; // inherited from GMUClusterItem

	readonly superclass: typeof NSObject; // inherited from NSObjectProtocol

	title: string; // inherited from GMUClusterItem
