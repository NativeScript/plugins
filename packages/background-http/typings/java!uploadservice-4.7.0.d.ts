			...
			export module logger {
				...
				export module UploadServiceLogger {
					export class Delegate {
						 ...
						 */
						public constructor(implementation: { error(param0: string, param1: string, param2: string, param3: java.lang.Throwable): void; debug(param0: string, param1: string, param2: string): void; info(param0: string, param1: string, param2: string): void });
						public constructor();
						public error(param0: string, param1: string, param2: string, param3: java.lang.Throwable): void;
						public info(param0: string, param1: string, param2: string): void;
						public debug(param0: string, param1: string, param2: string): void;
			...
			export module network {
				...
				export module BodyWriter {
					export class OnStreamWriteListener {
						 ...
						 */
						public constructor(implementation: { shouldContinueWriting(): boolean; onBytesWritten(param0: number): void });
						public constructor();
						public onBytesWritten(param0: number): void;
						public shouldContinueWriting(): boolean;
					}
		...
		export module uploadservice {
			export module network {
				export class HttpRequest {
					 ...
					 */
					public constructor(implementation: { setHeaders(param0: java.util.List<net.gotev.uploadservice.data.NameValue>): net.gotev.uploadservice.network.HttpRequest; setTotalBodyBytes(param0: number, param1: boolean): net.gotev.uploadservice.network.HttpRequest; getResponse(param0: net.gotev.uploadservice.network.HttpRequest.RequestBodyDelegate, param1: net.gotev.uploadservice.network.BodyWriter.OnStreamWriteListener): net.gotev.uploadservice.network.ServerResponse });
					public constructor();
				...
				export module HttpRequest {
					export class RequestBodyDelegate {
						 ...
						 */
						public constructor(implementation: { onWriteRequestBody(param0: net.gotev.uploadservice.network.BodyWriter): void });
						public constructor();
						public onWriteRequestBody(param0: net.gotev.uploadservice.network.BodyWriter): void;
					}
				}
		...
		export module uploadservice {
			export module network {
				export class HttpStack {
					 ...
					 */
					public constructor(implementation: { newRequest(param0: string, param1: string, param2: string): net.gotev.uploadservice.network.HttpRequest });
					public constructor();
			...
			export module observer {
				export module request {
					export class RequestObserverDelegate {
						 ...
						 */
						public constructor(implementation: { onProgress(param0: globalAndroid.content.Context, param1: net.gotev.uploadservice.data.UploadInfo): void; onSuccess(param0: globalAndroid.content.Context, param1: net.gotev.uploadservice.data.UploadInfo, param2: net.gotev.uploadservice.network.ServerResponse): void; onError(param0: globalAndroid.content.Context, param1: net.gotev.uploadservice.data.UploadInfo, param2: java.lang.Throwable): void; onCompleted(param0: globalAndroid.content.Context, param1: net.gotev.uploadservice.data.UploadInfo): void; onCompletedWhileNotObserving(): void });
						public constructor();
		...
		export module uploadservice {
			export module persistence {
				export class Persistable {
					 ...
					 */
					public constructor(implementation: { toPersistableData(): net.gotev.uploadservice.persistence.PersistableData });
					public constructor();
					public toPersistableData(): net.gotev.uploadservice.persistence.PersistableData;
				}
				export module Persistable {
					export class Creator<T> extends java.lang.Object {
						 ...
						 */
						public constructor(implementation: { createFromPersistableData(param0: net.gotev.uploadservice.persistence.PersistableData): T });
						public constructor();
		...
		export module uploadservice {
			export module placeholders {
				export class PlaceholdersProcessor {
					 ...
					 */
					public constructor(implementation: { processPlaceholders(param0: string, param1: net.gotev.uploadservice.data.UploadInfo): string });
					public constructor();
					public processPlaceholders(param0: string, param1: net.gotev.uploadservice.data.UploadInfo): string;
				}
			}
		...
		export module uploadservice {
			export module schemehandlers {
				export class SchemeHandler {
					 ...
					 */
					public constructor(implementation: { init(param0: string): void; size(param0: globalAndroid.content.Context): number; stream(param0: globalAndroid.content.Context): java.io.InputStream; contentType(param0: globalAndroid.content.Context): string; name(param0: globalAndroid.content.Context): string; delete(param0: globalAndroid.content.Context): boolean });
					public constructor();
					public init(param0: string): void;
					public size(param0: globalAndroid.content.Context): number;
					public stream(param0: globalAndroid.content.Context): java.io.InputStream;
