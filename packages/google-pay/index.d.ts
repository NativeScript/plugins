/// <reference path="../../node_modules/@nativescript/types-android/lib/android/android-platform-24.d.ts" />
...
export declare class GooglePayBtn extends View {
	...
	private _cardNetworksJsonArray;
	private _authMethodsJsonArray;
	private static TAG;
