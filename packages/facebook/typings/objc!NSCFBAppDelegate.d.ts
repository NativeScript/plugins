declare class NSCFBAppDelegate extends UIResponder implements UIApplicationDelegate {
	static alloc(): NSCFBAppDelegate; // inherited from NSObject

	static new(): NSCFBAppDelegate; // inherited from NSObject
