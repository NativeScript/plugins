...
const routes: Routes = [
	...
	{ path: 'video', loadChildren: () => import('./plugin-demos/video.module').then((m) => m.VideoModule) },
	{ path: 'video-advanced', loadChildren: () => import('./plugin-demos/video-advanced.module').then((m) => m.VideoAdvancedModule) },
